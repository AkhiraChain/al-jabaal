...
# Now you can simulate the process of moving assets between an EVM based chain and the al-jabaal chain. Since there
# is currently no running EVM chain, we will only see the al-jabaal chain update based on fictional claims from
